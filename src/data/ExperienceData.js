...
const projects = [
  {
    name: "Chow",
    description:
      "iOS, Android, and Web meal-ordering app focused on assisting restaurants affected by COVID-19",
    bullets: [
  ...
  },
  {
    name: "Journey",
    description:
      "Mental-health focused journal and psychoanalysis tool, powered by Web and Alexa",
    bullets: [
...
export { professional, projects, education };
